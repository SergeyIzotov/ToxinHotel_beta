    ...
    !function () {
        ...
        n = m, n.prototype = {
            ...
            ru: {
                ...
                today: "Сегодня",
                clear: "Очистить",
                apply: "Применить", // Надзвание кнопки
        ...
        s.Body = function (t, i, s) {
            ...
            init: function () {
                ...
                return r.onRenderCell && (d = r.onRenderCell(t, e) || {}, l = d.html ? d.html : l, i += d.classes ? " " + d.classes : ""), r.range && (a.isSame(h, t, e)
                && (i += " -range-from-"), a.isSame(o, t, e) && (i += " -range-to-"), 1 == n.selectedDates.length
                && n.focused ? ((a.bigger(h, t) && a.less(n.focused, t) || a.less(o, t) && a.bigger(n.focused, t))
                && (i += " -in-range-"), a.less(o, t) && a.isSame(n.focused, t) && (i += " -range-from-"), a.bigger(h, t)
                && a.isSame(n.focused, t) && (i += " -range-to-")) : 2 == n.selectedDates.length && a.bigger(h, t)
                    && a.less(o, t) && (i += " -in-range-")), a.isSame(s, t, e) && (i += " -current-"), n.focused
                && a.isSame(t, n.focused, e) && (i += " -focus-"), n._isSelected(t, e) && (i += " -selected-"), (!n._isInRange(t, e) || d.disabled)
                && (i += " -disabled-"), {
                    html: l,
                    classes: i
                }
        ...
        a.Navigation = function (t, e) {
            ...
            init: function () {
                ...
                this.opts.applyButton && this._addButton("apply") // Добавление кнопки
            }, _render: function () {
